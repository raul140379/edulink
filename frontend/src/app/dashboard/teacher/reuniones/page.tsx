  ...
  return (
    <div>
      ...
      <style>{`
        ...
        .btn-icon.edit{background:#FAEEDA;color:#633806}
        .btn-icon.edit:hover{background:#633806;color:#fff}
        ...
        .att-badge.p{background:#633806;color:#fff}
        .att-badge.a{background:#C0392B;color:#fff}
        .btn-primary{display:flex;align-items:center;gap:6px;padding:9px 16px;background:#633806;color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:500;cursor:pointer;white-space:nowrap}
