  ...
  return (
    <div>
      ...
      <style>{`
        ...
        .btn-detalle:hover{border-color:#633806;color:#633806}
  ...
  return (
    <div className="detalle-wrap">
      ...
      <div className="dim-grid">
        ...
        <DimCard label="Ser"            max={10} value={nota.ser}            color="#633806" items={null}/>
      ...
      <div className="section-card">
        <div className="section-title" style={{color:'#633806'}}>
          Ser <span className="dim-badge" style={{background:'#FFF3E6',color:'#633806'}}>máx 10 pts</span>
        </div>
        {nota.cerrado
      ...
      <style>{`
        ...
        .btn-guardar{display:inline-flex;align-items:center;gap:6px;padding:7px 14px;background:#633806;color:#fff;border:none;border-radius:8px;font-size:13px;cursor:pointer}
