  ...
  return (
    <div>
      ...
      <style>{`
        ...
        .btn-primary{display:flex;align-items:center;justify-content:center;gap:6px;padding:10px 20px;background:#633806;color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:500;cursor:pointer}
        ...
        .notif-type{font-size:11px;font-weight:500;background:#FDF0E6;color:#633806;padding:2px 8px;border-radius:10px}
        ...
        .spinner{width:20px;height:20px;border:2px solid rgba(99,56,6,.2);border-top-color:#633806;border-radius:50%;animation:spin .7s linear infinite}
