  ...
  return (
    ...
    <span className="meta-pill" style={{background:'#E8F0FB',color:'#1A3A7C'}}>
      ...
      <div className="quick-actions">
        <button className="action-btn blue" onClick={() => router.push('/dashboard/teacher-tutor/tesoreria')}>
          <DollarSign size={18}/> Estado de cuentas
        </button>
        <button className="action-btn orange" onClick={() => router.push('/dashboard/teacher-tutor/reuniones')}>
          <Users size={18}/> Convocar reunión
        </button>
        <button className="action-btn green" onClick={() => router.push('/dashboard/teacher-tutor/notificaciones')}>
