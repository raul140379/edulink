  ...
  return (
    <div>
      ...
      <div className="quick-actions">
        <button className="action-btn blue" onClick={() => router.push('/dashboard/delegate/tesoreria')}>
          <DollarSign size={18}/> Ver estado de cuentas
        </button>
        <button className="action-btn green" onClick={() => router.push('/dashboard/delegate/cargos/nuevo')}>
          <CreditCard size={18}/> Nuevo cargo
        </button>
        <button className="action-btn purple" onClick={() => router.push('/dashboard/delegate/asistencia')}>
