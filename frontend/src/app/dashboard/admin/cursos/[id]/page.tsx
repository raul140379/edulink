  ...
  import { ArrowLeft, Users, BookOpen, Clock, GraduationCap, Plus  } from 'lucide-react'
  ...
  <div className="section-title" style={{justifyContent:'space-between'}}>
    <span style={{display:'flex',alignItems:'center',gap:'8px'}}>
      <BookOpen size={15}/> Materias y Maestros ({course.teacherSubjects.length})
    </span>
  ...
  {course.teacherSubjects.length === 0 ? (
    <div style={{padding:'20px 18px',fontSize:'13px',color:'#6B8BB0',fontStyle:'italic'}}>
    ...
    {course.tutor ? (
      ...
      <div style={{display:'flex',alignItems:'center',justifyContent:'space-between'}}>
        ...
        <style>{`
          ...
          .btn-primary-sm{padding:6px 14px;background:#1A3A7C;color:#fff;border:none;border-radius:6px;font-size:12px;cursor:pointer}
