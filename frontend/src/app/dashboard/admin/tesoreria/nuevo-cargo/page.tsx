  ...
  const handleSave = async () => {
    ...
    try {
      if (bulk) {
        ...
        setTimeout(() => router.push('/dashboard/admin/tesoreria'), 1500)
      } else {
        ...
        setTimeout(() => {
          if (preParentId) router.push(`/dashboard/admin/tesoreria/${preParentId}`)
          else router.push('/dashboard/admin/tesoreria')
        }, 1500)
      }
    } catch { setError('Error de conexión') }
  ...
  return (
    <div className="container">
      ...
      <style>{`
        ...
        .page-header h1{font-size:20px;font-weight:700;color:#0A5A45}
        ...
        .form-card{background:#fff;border:1px solid #DCEEE6;border-radius:14px;padding:24px;display:flex;flex-direction:column;gap:18px}
        .mode-toggle{display:flex;background:#F5FAF7;border-radius:10px;padding:4px;gap:4px}
        .mode-btn{flex:1;padding:8px;border:none;border-radius:8px;font-size:13px;cursor:pointer;background:transparent;color:#6B8F7F;display:flex;align-items:center;justify-content:center;gap:6px;transition:all .15s}
        .mode-btn.active{background:#fff;color:#0A5A45;font-weight:600;box-shadow:0 1px 4px rgba(0,0,0,.1)}
        .info-box{background:#F5FAF7;border:1px solid #DCEEE6;border-radius:8px;padding:12px;font-size:12px;color:#6B8F7F;line-height:1.6}
        .section-lbl{font-size:12px;font-weight:700;color:#0A5A45;text-transform:uppercase;letter-spacing:.6px;padding-bottom:4px;border-bottom:1px solid #F5FAF7}
        ...
        .field-hint{font-size:11px;color:#6B8F7F;margin-top:2px}
        ...
        .btn-sm-outline{padding:6px 12px;background:#fff;color:#0A5A45;border:1.5px solid #DCEEE6;border-radius:6px;font-size:12px;cursor:pointer}
        .btn-sm-outline:hover{background:#F5FAF7}
        .parents-select{display:flex;flex-direction:column;gap:6px;max-height:280px;overflow-y:auto;border:1.5px solid #DCEEE6;border-radius:8px;padding:8px}
        ...
        .parent-option:hover{background:#F5FAF7}
        .parent-option.selected{background:#E0ECF8;border-color:#DCEEE6}
        .parent-option input{accent-color:#0A5A45;cursor:pointer;width:16px;height:16px;flex-shrink:0}
        .parent-name{font-size:13px;font-weight:500;color:#0A5A45}
        .parent-ci{font-size:11px;color:#6B8F7F}
        .form-actions{display:flex;justify-content:flex-end;gap:10px;padding-top:8px;border-top:1px solid #F5FAF7}
        .btn-primary{display:flex;align-items:center;gap:6px;padding:10px 20px;background:#0A5A45;color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:500;cursor:pointer}
        .btn-primary:hover:not(:disabled){background:#4A9FD4}
        .btn-primary:disabled{opacity:.6;cursor:not-allowed}
        .btn-outline{display:flex;align-items:center;gap:6px;padding:10px 16px;background:#fff;color:#0A5A45;border:1.5px solid #DCEEE6;border-radius:8px;font-size:13px;cursor:pointer}
