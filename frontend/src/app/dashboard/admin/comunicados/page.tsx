...
export default function ComunicadosPage() {
  ...
  const handleUnpublish = async (id: number) => {
    const ok = await confirm('¿Despublicar este comunicado? Dejará de verse en el portal público.', { danger: true, confirmLabel: 'Despublicar' })
    if (!ok) return
    try {
    ...
    <div>
      <div className="flex items-start justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-[13px] text-neutral-500">Contenido público del portal del distrito</p>
        </div>
