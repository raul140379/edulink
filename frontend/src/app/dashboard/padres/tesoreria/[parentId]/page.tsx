...
import { ArrowLeft, Plus, DollarSign, CheckCircle, AlertCircle, Clock, CreditCard } from 'lucide-react'
        ...
        {selectedCharge && (
          <div className="flex flex-col gap-4">
            <div className="bg-neutral-100 border border-neutral-300 rounded-lg p-3 text-[13px] text-neutral-500 leading-relaxed">
              ...
              Saldo pendiente: <strong className="text-danger-600">{fmt(selectedCharge.amount - selectedCharge.paidAmount)}</strong>
            </div>
            <Input
              label="Monto a pagar (Bs.)" required type="number" step="0.01" min="0.01"
