...
// Reusa el mismo endpoint /api/comunicados que admin/comunicados/page.tsx — el
// backend ya resuelve el alcance (colegio/núcleo/distrito) según el rol de quien
// publica y de quien consulta, ver comunicado.service.ts.
export default function PadresComunicadosPage() {
