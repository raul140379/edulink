...
import { Building2, Megaphone, ArrowRight, DollarSign } from 'lucide-react'
...
// Home de la Junta de Núcleo — mismo espíritu que _JuntaDistritoHome.tsx pero
// acotado a los colegios de su propio núcleo (el motor de scoping ya filtra
// /api/schools y /api/comunicados automáticamente).
export default function JuntaNucleoHome() {
    ...
    <div>
      <div className="bg-brand-700 rounded-2xl px-7 py-6 flex items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-info-500 text-[13px]">Junta de Núcleo</p>
        </div>
      ...
      <div className="grid gap-4 mb-6" style={{ gridTemplateColumns: '1.3fr 1fr' }}>
        ...
        <Card>
          <CardHeader><CardTitle className="flex items-center gap-2"><DollarSign size={16}/> Accesos rápidos</CardTitle></CardHeader>
          <div className="flex flex-col gap-1">
            <Link href="/dashboard/padres/comunicados" className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-[13px] text-brand-700 hover:bg-neutral-100 transition-colors">
              <Megaphone size={16}/> Publicar comunicado / convocatoria
            </Link>
            <Link href="/dashboard/padres/tesoreria" className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-[13px] text-brand-700 hover:bg-neutral-100 transition-colors">
      ...
      <Card>
        <CardHeader>
          ...
          <Link href="/dashboard/padres/comunicados" className="text-[12.5px] font-semibold text-brand-600 flex items-center gap-1 hover:text-brand-700">
