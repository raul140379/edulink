...
// Home de la Junta de Distrito — análogo a admin/_DistrictHome.tsx pero desde la
// óptica de la Junta de Padres: colegios/núcleos de su distrito y comunicados
// recientes, con accesos a designar Junta de Núcleo/Escolar (vía Usuarios).
export default function JuntaDistritoHome() {
    ...
    <div>
      <div className="bg-brand-700 rounded-2xl px-7 py-6 flex items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-info-500 text-[13px]">Junta de Distrito — {district.name}</p>
        </div>
