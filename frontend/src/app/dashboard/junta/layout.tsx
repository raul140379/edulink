...
const menuItems = [
  ...
  },
  {
    ...
    href:  '/dashboard/junta/notificaciones',
    icon:  <Bell size={18}/>,
  },
]

export default function JuntaLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (parsed.role !== 'JUNTA_ESCOLAR' && parsed.role !== 'SUPER_ADMIN') {
        ...
        <div className="sidebar-brand">
          ...
          {!collapsed && (
            <div className="brand-info">
              <span className="brand-name">Junta Escolar</span>
      ...
      <div className="user-profile">
        ...
        {!collapsed && (
          <div className="user-info">
            ...
            <span className="user-role-badge">Junta Escolar</span>
          </div>
        )}
      </div>
    ...
    <div className="dashboard-root">
      ...
      <div className="main-wrapper">
        <header className="main-header">
          ...
          <div className="header-title">
            {menuItems.find(i => pathname === i.href || pathname.startsWith(i.href + '/'))?.label || 'Dashboard'}
          </div>
          <div className="header-badge">Junta Escolar</div>
        </header>
      ...
      <style>{`
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        /* SIDEBAR */
        .sidebar { width:var(--sidebar-w); background:var(--verde); display:flex; flex-direction:column; position:fixed; top:0; left:0; bottom:0; z-index:100; transition:width 0.2s ease; overflow:hidden; }
        ...
        /* SIDEBAR MÓVIL */
        .sidebar-mobile { display:none; width:var(--sidebar-w); background:var(--verde); position:fixed; top:0; left:-100%; bottom:0; z-index:200; transition:left 0.25s ease; overflow:hidden; }
        ...
        .mobile-menu-btn { display:none; background:none; border:none; cursor:pointer; color:var(--verde); padding:6px; border-radius:6px; }
        .mobile-menu-btn:hover { background:#F0F6FC; }
        .header-title { flex:1; font-size:15px; font-weight:600; color:var(--verde); }
        .header-badge { background:#E1F5EE; color:var(--verde); padding:4px 12px; border-radius:20px; font-size:11px; font-weight:600; }
