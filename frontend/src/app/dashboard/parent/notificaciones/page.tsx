  ...
  return (
    <div>
      ...
      <style>{`
        ...
        .notif-card.unread{border-left:4px solid #27500A;background:#FAFFF8}
        ...
        .btn-read{display:flex;align-items:center;gap:5px;padding:6px 12px;background:#E8F5E0;color:#27500A;border:1px solid #9FE1CB;border-radius:8px;font-size:12px;cursor:pointer;font-weight:500;white-space:nowrap}
        .btn-read:hover{background:#27500A;color:#fff}
        .btn-outline{display:flex;align-items:center;gap:6px;padding:8px 14px;background:#fff;color:#27500A;border:1.5px solid #9FE1CB;border-radius:8px;font-size:13px;cursor:pointer;white-space:nowrap}
        .btn-outline:hover{background:#E8F5E0}
