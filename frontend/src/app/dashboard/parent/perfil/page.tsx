  ...
  return (
    <div>
      ...
      <style>{`
        ...
        .fg input:focus{border-color:#27500A;box-shadow:0 0 0 3px rgba(39,80,10,.1)}
        ...
        .btn-primary{display:flex;align-items:center;justify-content:center;gap:6px;padding:10px 16px;background:#27500A;color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:500;cursor:pointer;width:100%}
        .btn-primary:hover:not(:disabled){background:#1A3A06}
