...
import {
  LayoutDashboard, DollarSign, Bell, BookOpen,
  LogOut, Menu, X, ChevronRight, Users, UserCircle, Calendar
} from 'lucide-react'
...
const menuItems = [
  { label: 'Inicio',           href: '/dashboard/parent',                icon: <LayoutDashboard size={18}/> },
   { label: 'Horario',          href: '/dashboard/parent/horario',          icon: <Calendar size={18}/> },
...
export default function ParentLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (parsed.role !== 'PARENT' && parsed.role !== 'SUPER_ADMIN') {
        ...
        <div className="sidebar-brand">
          ...
          {!collapsed && (
            <div className="brand-info">
              <span className="brand-name">Padre / Tutor</span>
    ...
    <div className="dashboard-root">
      ...
      <style>{`
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        :root{--parent:#27500A;--amarillo:#F5C518;--sidebar-w:240px;--sidebar-collapsed:64px;--header-h:56px}
        ...
        .sidebar{width:var(--sidebar-w);background:var(--parent);display:flex;flex-direction:column;position:fixed;top:0;left:0;bottom:0;z-index:100;transition:width 0.2s ease;overflow:hidden}
        ...
        .sidebar-mobile{display:none;width:var(--sidebar-w);background:var(--parent);position:fixed;top:0;left:-100%;bottom:0;z-index:200;transition:left 0.25s ease;overflow:hidden}
