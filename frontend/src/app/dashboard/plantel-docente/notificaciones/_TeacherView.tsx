  ...
  return (
    <div>
      ...
      <style>{`
        ...
        .tipo-btn:hover{border-color:#1565C0;background:#E3F2FD}
        .tipo-btn.active{border-color:#1565C0;background:#1565C0;color:#fff}
        ...
        .student-item input{accent-color:#1565C0;cursor:pointer;flex-shrink:0;width:14px;height:14px}
        ...
        .notify-box{background:#E3F2FD;border:1px solid #F5C518;border-radius:8px;padding:12px}
        ...
        .btn-primary{display:flex;align-items:center;justify-content:center;gap:6px;padding:10px 16px;background:#1565C0;color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:500;cursor:pointer;width:100%}
