...
28.2. 🟢 **Deuda técnica, no urgente — cuentas `JUNTA_ESCOLAR` de prueba sin uso real, candidatas a limpieza futura**: `paulina.sandoval2@nnuu.edu.bo` (local id 2389), `paulina.sandoval3@nnuu.edu.bo` (local id 2390), `evelin.balderrama2@nnuu.edu.bo` (local id 2391) — las 3 solo en local, nunca llegaron a producción — y `raul.martinezA@eltorno.edu.bo` (producción id 2311). Ninguna bloquea nada, no se toca sin pedido explícito.
