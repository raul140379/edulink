...
//
// Copia verbatim de frontend/src/lib/attendancePdf.ts (7-sep-2026) — no hay
// monorepo/workspace entre frontend y maestro-app (2 proyectos Next.js
// totalmente separados, cada uno con su propio node_modules), así que no se
// puede importar directo. El archivo es autocontenido (solo importa jspdf/
// jspdf-autotable de forma dinámica, sin ningún otro import interno), lo que
// lo hace seguro de duplicar — mismo criterio ya usado para GRADES/
// courseLabel en curso/[id]/page.tsx. Si el original cambia, replicar el
// cambio acá a mano.
